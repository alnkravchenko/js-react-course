    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{ margin: '0 auto', background: 'none', display: 'block' }} width="300px" height="300px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            <g transform="rotate(0 50 50)">
                <rect x="46.5" y="26" rx="3.5" ry="4" width="7" height="8" fill="#9F0013">
                ...
                <rect x="46.5" y="26" rx="3.5" ry="4" width="7" height="8" fill="#fdbd10">
                ...
                <rect x="46.5" y="26" rx="3.5" ry="4" width="7" height="8" fill="#0b0b31">
